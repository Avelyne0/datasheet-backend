...
weapons = Weapon.create([ 
  ...
  { weapon_name: 'Arc Rifle', weapon_range: 24, weapon_type: 'Rapid Fire 1', weapon_strength: 6, armour_piercing: '-1', weapon_damage: 1, weapon_ability: 'When attacking a <VEHICLE>, this weapon has a Damage of D3', user_id: 1},
  { weapon_name: 'Avenger Gattling Cannon', weapon_range: 36, weapon_type: 'Heavy 12', weapon_strength: 6, armour_piercing: '-2', weapon_damage: 2, weapon_ability: '-', user_id: 1},
  { weapon_name: 'Cognis Heavy Stubber', weapon_range: 36, weapon_type: 'Heavy 3', weapon_strength: 4, armour_piercing: '0', weapon_damage: 1, weapon_ability: 'You may fire this weapon even if the firing model has Advanced but you must subtract 2 from any hit rolls if you do so', user_id: 1},
])
